...
[![x-cmd/install — argo-workflows Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/argo-workflows.svg?lang=zh)](https://x-cmd.com/install/argo-workflows)
...
合计: **1,333,384** 行代码（覆盖前 5 种语言、共 **2088** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Yaml | 1,011,822 | 1,656 | 2,311 | 750 |
| Go | 263,962 | 13,582 | 25,067 | 1030 |
| Json | 31,156 | 0 | 0 | 13 |
...
- **上游仓库**: <https://github.com/argoproj/argo-workflows>
- **官网**: <https://argo-workflows.readthedocs.io/>
- **许可证**: Apache-2.0
...
- **Star**: 17,000 · **Fork**: 3,670 · **开放 issue**: 6,674 · **贡献者**: 1,020

## 累计统计

- **发布数**: 360 · **已合并 PR**: 7186 · **开放 PR**: 306 · **已关闭 issue**: 5687 · **开放 issue**: 987 · **提交数**: 6837

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 4 | 151 | 54 | 6 | 21 | 107 |
| last60d | 2026-07-25 | 11 | 323 | 79 | 25 | 43 | 219 |
| 90d | 2026-06-25 | 16 | 514 | 88 | 40 | 48 | 354 |
| last180d | 2026-03-27 | 22 | 807 | 137 | 78 | 77 | 563 |
| 360d | 2025-09-28 | 48 | 1431 | 180 | 164 | 139 | 976 |
| last720d | 2024-10-03 | 74 | 1923 | 255 | 416 | 298 | 1395 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/argo-workflows.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T06:11:05Z._
